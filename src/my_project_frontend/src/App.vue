...
<template>
  <main class="container mx-auto">
    ...
    <br />
    <br />
    <form class="grid gap-4 pb-4 mb-4 border-solid border-2 border-indygo-500" action="#" @submit="handleSubmit">
      <div>
      ...
      <div>
        <p class="text-black front-bold">Content: </p>
        <textarea
        id="content" 
        alt="content" 
        type="text" 
      ...
      <div>
        <p class="text-black front-bold">Tags: </p>
        <input 
        id="tags" 
        alt="tags" 
        type="text" 
        ...
        hover:border-indigo-500
        " />
        <div class="flex gap-1 flex-warp my-2">
